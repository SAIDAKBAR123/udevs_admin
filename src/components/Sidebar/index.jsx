    ...
    <div className="flex h-screen h-full" style={{ height: "100%" }}>
      ...
      >
              ...
              <li key={el.title}>
                ...
                >
                  <BootstrapTooltip title={el.title}>
                    <span
                      className={`active-sidebar w-14 h-14 flex items-center justify-center space-x-2 text-gray-700 p-0 rounded-md`}
                    >
        ...
        <div className="flex flex-col items-center space-y-5">
          <ul className="space-y-2 items-end dashboard_list font-body transition hover:text-white ease-in-out transform hover:rotate-12 cursor-pointer">
          ...
          >
            ...
            {anchorEl ? (
              <div className="h-32 rounded p-2 shadow-2xl w-40 bg-background absolute left-16 bottom-12 z-10">
                Set cont
              </div>
            ) : (
              ""
      ...
      <div
        className={`h-screen sidebar bg-white w-60 ${
          visible ? "p-3" : "inset-0 transform -translate-x-4 overflow-hidden"
        }`}
        style={{
          height: "100%",
          marginLeft: 49,
      ...
      >
        <div className="flex justify-between items-center w-full px-3">
          <span className="items-center">
            <h3 className="font-bold text-3xl text-gray-700 font-poppins tracking-wide">
